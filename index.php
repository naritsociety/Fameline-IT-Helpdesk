...
?></td>
      ...
      <tr>
        <td colspan="2">
          <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#999999">
            <tr>
              <td width="8%"><div align="center">Job.ID</div></td>
              <td width="15%"><div align="center">Job.Detail</div></td>
              <td width="8%"><div align="center">UserName</div></td>
              <td width="10%"><div align="center">Department</div></td>
  			      <td width="8%"><div align="center">Problem</div></td>
              <td width="5%"><div align="center">Tel</div></td>
  			      <td width="13%"><div align="center">Email</div></td>
              <td width="8%"><div align="center">Job_Date</div></td>
...
?>
          ...
          <tr  onMouseOver="this.style.backgroundColor='cccccc';" onMouseOut="this.style.backgroundColor='ffffff';">
			...
			<td width="10%"><div align="center">
				<!--<?=$objResult["ref_type_id"];?>-->
			
			<?
        if($objResult['ref_type_id']==1){
          echo "Computer";
        }
        if($objResult['ref_type_id']==2){
          echo "ERP(AX)";
        }
        if($objResult['ref_type_id']==3){
          echo "Network";
        }
        if($objResult['ref_type_id']==4){
          echo "Printer";
        }
        if($objResult['ref_type_id']==5){
          echo "Email";
        }
        if($objResult['ref_type_id']==6){
          echo "Backup Data";
        }
        if($objResult['ref_type_id']==7){
          echo "Software";
        }
        if($objResult['ref_type_id']==8){
          echo "Other";
        }
    	;?>		
            ...
            <td width="8%"><div align="center"><?=$objResult["job_date"];?></div><div align="center"></div></td>
